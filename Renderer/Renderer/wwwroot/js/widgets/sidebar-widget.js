document.addEventListener("DOMContentLoaded", function () {
    ...
    const mobileBreadcumb = document.querySelector(".mobile-drawer");
    ...
    async function updateUrlAndFetch(region = null, subregion = null, clearSubregion = false) {
        ...
        try {
            ...
            const newMobileBreadcumb = doc.querySelector(".mobile-drawer");
            if (newContent) {
                setTimeout(() => {
            ...
            if (newMobileBreadcumb) {
                mobileBreadcumb.innerHTML = newMobileBreadcumb.innerHTML;
            }
    ...
    mobileSubRegionFilter.forEach(link => {
        link.addEventListener("click", function (e) {
            ...
            updateUrlAndFetch(parentRegion, selectedSubregion, false);
        });
    });
